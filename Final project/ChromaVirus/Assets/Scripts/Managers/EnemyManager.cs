...
public class EnemyManager : MonoBehaviour {
    ...
    public void TurretSpawned(EventInfo eventInfo)
    {
        ++turrets;
    }

    public void TurretDestroyed(EventInfo eventInfo)
    {
        --turrets;
    }

    public void SpawnerActivated(EventInfo eventInfo)
    {
        ++spawners;
    }

    public void SpawnerDestroyed(EventInfo eventInfo)
    {
        --spawners;
    }
