...
public class GridSize {
    ...
    public function GetTotalAABCCount(): int
    {
    ...
    public function GetAABCCenterFromGridOriginUnchecked(x : short, y : short, z : short) : Vector3 {
