...
{
    /*if (aABCGrids != null)
        Debug.Log("JS Grid Number = " + aABCGrids.Count);
    else
        Debug.Log("JS aABCGrids is null");*/

    if (aABCGrids != null)
    {
        //flag = false;
        var startTime = Time.realtimeSinceStartup;
        //Debug.Log("Start JS gizmo drawing:");
            ...
            if(drawMeshShell && aABCGrid) 
            {
                ...
                for(var x = 0; x < gridSize.x; ++x) 
                {
                    for(var y = 0; y < gridSize.y; ++y) 
                    {
                        ...
                        {
                            var cubeCenter = aABCGrid.GetAABCCenterFromGridOriginUnchecked(x, y, z) + 
                                    aABCGrid.GetOrigin() + 
        ...
        //Debug.Log("End JS gizmo drawing: ");
    }
}
